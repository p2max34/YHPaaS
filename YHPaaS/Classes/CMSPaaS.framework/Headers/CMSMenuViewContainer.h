...
@interface CMSMenuViewContainer : UIView
...
/**
 menuView
 */
@property(nonatomic, strong) CMSMenuDefaultView *menuView;
 ...
 */
@property(nonatomic, assign) CMSMenuControllerArrowDirection arrowDirection ;
