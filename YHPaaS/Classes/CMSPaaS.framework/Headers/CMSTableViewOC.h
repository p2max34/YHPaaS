...
@interface CMSTableSectionModelOC : NSObject
...
/// cell Height
typedef CGFloat (^CMSCellHeightWithModelAndIndexBlock)(id model,NSIndexPath *indexPath);
...
typedef void(^CMSConfigCellDidEndDisplayingBlock)(id model, UITableViewCell *cell, NSIndexPath *indexPath);
typedef void(^CMSSelectCellAtRowModelBlock)(id model , NSIndexPath *indexPath);

typedef NSDictionary *_Nonnull(^CMSSectionViewIdentifierAndClassOfModelBlock)(BOOL isHeaderView,CMSTableSectionModelOC * sectionModel,NSInteger section);
typedef void(^CMSConfigSectionViewWithModelBlock)(CMSTableSectionModelOC * sectionModel,UIView *sectionView);
//typedef void(^CMSSectionViewTapGestureWithModelBlock)(CMSTableSectionModelOC * sectionModel,UIView *);
...
@interface CMSTableViewOC : UITableView

/// 数据源  数组中放的 CMSTableSectionModelOC
@property (nonatomic, copy) NSArray *datas;

/// tableViewcell 是否可以编辑
@property (nonatomic,assign,getter=isCanEdit) BOOL canEdit;
/// tableViewcell 是否需要预算高度
@property (nonatomic,assign,getter=isSetEstimatedHeight) BOOL setEstimatedHeight; // 
...
@property (nonatomic,copy) CMSConfigCellDidEndDisplayingBlock configCellDidEndDisplayingBlock;
///设置 cell  的 高度
@property (nonatomic,copy) CMSCellHeightWithModelAndIndexBlock cellHeightWithModelAndIndexBlock;
